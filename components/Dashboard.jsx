...
export default function DashboardApp(props) {
  ...
  let colors = {
    ...
    // indigo: {
    //   default: "rgba(150, 42, 120, 1)",
    //   half: "rgba(150, 42, 120, 0.5)",
    //   quarter: "rgba(150, 42, 120, 0.25)",
    //   zero: "rgba(150, 42, 120, 0)",
    // },
  };
  ...
  useEffect(() => {
    ...
    // const gradientX = ctx.createLinearGradient(0, 16, 0, 600);
    ...
    let weight = [60.0, 60.2, 59.1, 61.4, 59.9, 60.2, 59.8, 58.6, 59.6, 59.2];

    weight = props.weightList;
